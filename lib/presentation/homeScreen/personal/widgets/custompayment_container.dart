...
class CustomPaymentOperation_Container extends StatefulWidget {
  @override
  State<CustomPaymentOperation_Container> createState() => _CustomPaymentOperation_ContainerState();
}

class _CustomPaymentOperation_ContainerState extends State<CustomPaymentOperation_Container> {
  @override
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: ColorManager.midWhiteColor, spreadRadius: 2, blurRadius: 4, offset: Offset(0, 3))
            ]),
