...
class SharedPreferencesServicesImpl extends SharedPreferencesServices {
  ...
  Future<bool> saveData({
    ...
    final method = _getSharedPrefsMethod(restoring: false, dataType: dataType);
  ...
  Future<dynamic> getData({
    ...
    final method = _getSharedPrefsMethod(restoring: true, dataType: dataType);
    return method(key);
  }
