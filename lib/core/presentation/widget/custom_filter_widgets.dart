...
class SelectedFilterWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        margin: EdgeInsets.symmetric(horizontal: AppSizes.pw4, vertical: AppSizes.ph2),
        padding: EdgeInsets.symmetric(horizontal: AppSizes.pw8, vertical: AppSizes.ph6),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          Icon(Icons.check_circle, size: AppSizes.ph20, color: ColorManager.whiteColor),
          Padding(
              padding: EdgeInsets.symmetric(horizontal: AppSizes.pw4, vertical: AppSizes.ph1),
              child:
...
class Filter_Icon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        margin: EdgeInsets.symmetric(horizontal: AppSizes.pw4, vertical: AppSizes.ph2_5),
        padding: EdgeInsets.symmetric(horizontal: AppSizes.pw8, vertical: AppSizes.ph6),
        decoration: BoxDecoration(boxShadow: [
          BoxShadow(color: ColorManager.lightBlueColor, spreadRadius: 0, blurRadius: 1, offset: const Offset(0, 1))
        ], color: ColorManager.primaryBlueColor, borderRadius: BorderRadius.circular(AppSizes.br16)),
