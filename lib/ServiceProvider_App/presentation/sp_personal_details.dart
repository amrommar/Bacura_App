...
import '../../presentation/homeScreen/home_tab/service_request/widgets/dropdown_field.dart';
import '../../presentation/homeScreen/personal/widgets/custom_row_details.dart';

class Sp_PersonalDetails_Screen extends StatefulWidget {
  const Sp_PersonalDetails_Screen({super.key});

  @override
  State<Sp_PersonalDetails_Screen> createState() => _Sp_PersonalDetails_ScreenState();
}

class _Sp_PersonalDetails_ScreenState extends State<Sp_PersonalDetails_Screen> {
              ...
              child: Custom_Container(
                  childWidget: Row(
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Icon(Icons.calendar_month_outlined, color: ColorManager.midBlueColor),
                      SizedBox(width: 10.w),
                      Text('التقويم',
                          style: Theme.of(context).textTheme.titleMedium!.copyWith(color: ColorManager.darkBlueColor))
                    ]),
                    SizedBox(width: 10.w),
                    Icon(Icons.navigate_next_rounded, size: 28, color: ColorManager.darkBlueColor)
                  ]))),
