...
class SpOrderDetailsScreen extends StatefulWidget {
  const SpOrderDetailsScreen({super.key});

  @override
  State<SpOrderDetailsScreen> createState() => _SpOrderDetailsScreenState();
}

class _SpOrderDetailsScreenState extends State<SpOrderDetailsScreen> {
  @override
      ...
      body: Container(
          ...
          child: SingleChildScrollView(
            ...
            ///  Payment status section/////////////////////////////////////////////
                ...
                title: AppLocalizations.of(context)!.payment_status, description: 'تم الدفع', icon: Icons.check_circle, iconColor: ColorManager.darkGreenColor),
