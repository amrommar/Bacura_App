...
class _SpCalenderWidgetState extends State<SpCalenderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CalenderOrdersProvider>(
      builder: (context, calenderProvider, child) => Container(
        ...
        child: Calendar(
          ...
          onDateSelected: (DateTime date) {
            calenderProvider.selectedDate = DateParser.dateFormatterWithoutTime(date);
            calenderProvider.setSelectedDate(date.toString());
          },
        ),
      ),
    );
