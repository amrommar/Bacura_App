      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 10),
            CustomRegistrationTextField(hintText: AppLocalizations.of(context)!.responsible_name),
            CustomRegistrationTextField(hintText: AppLocalizations.of(context)!.commercial_registration_number),
            ...
            UploadImageFieldIcon(label: AppLocalizations.of(context)!.commercial_registration_image),
            const SizedBox(height: 10),
