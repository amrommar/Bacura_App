...
class VerifyProvider extends ChangeNotifier {
  ...
  Future<void> validatePin(BuildContext context, String phone) async {
    if (pinCode.isEmpty) {
      ...
      // check phone number
      var result = await sl<VerifyOTPUseCase>().call(VerifyParameter(phone: phone, countryCode: AppConstants.countryCode, otp: pinCode));
      result.fold((l) {}, (r) {
        verifyOtpEntity = r;
